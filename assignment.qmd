...
For the base model, we used 3 layers. For the input layer, the ReLU activation function will be used with 201 units. And for the hidden layers, we usehe the softmax activation will be used for output layer and ReLU activation for the input layers.
